(function () {
        ...
        if (e.target.classList.contains('eliminar')) {
            ...
            if (confirmar) {
                ...
                transaction.oncomplete = function () {
                    ...
                    imprimirAlerta('Cliente eliminado correctamente')
                }
                transaction.onerror = function () {
                    console.log('Hubo un error para eliminarlo');
                }
            }
        }
    }
    ...
    function crearDB() {
        ...
        crearDB.onerror = function () {
            console.log('Hubo un error en la creacion de la Base de datos');
        };
    ...
    function obtenerClientes() {
        ...
        abrirConexion.onerror = function () {
            console.log('Hubo un error en la obtencion de los clientes');
        };
